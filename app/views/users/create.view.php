<form autocomplete="off" class="appForm clearfix" method="post" enctype="application/x-www-form-urlencoded">
    <fieldset>
        ...
        <div class="input_wrapper n35 border">
        ...
        <div class="input_wrapper n35 border padding">
        ...
        <div class="input_wrapper n30 padding">
            ...
            <input data-language="en" required type="text" name="PhoneNumber" value="<?= $this->showValue('PhoneNumber') ?>">
        </div>
        <div class="input_wrapper_other left_padding n50 select border">
            <select required name="GroupId">
                ...
                <?php if (false !== $groups): foreach ($groups as $group): ?>
                    <option <?= $this->selectedIf('GroupId', $group->GroupId) ?> value="<?= $group->GroupId ?>"><?= $group->GroupName ?></option>
