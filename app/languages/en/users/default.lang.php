...
$_['text_table_control_edit'] = 'Edit user details';
$_['text_table_control_delete'] = 'Delete user';
$_['text_table_control_reset'] = 'Reset user password';
$_['text_table_control_suspend'] = 'Suspend user account';
$_['text_table_control_activate'] = 'Activate user account';
